...
*/
func GenerateClientSecret(file []byte, teamID, clientID, keyID string) (string, error) {
	...
	claims := &jwt.RegisteredClaims{
		...
		ExpiresAt: &jwt.NumericDate{Time: now.Add(time.Hour*24*180 - time.Second)}, // 180 days
